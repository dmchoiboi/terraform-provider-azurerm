...
* `format` - (Required) The format of the Cognitive Services Account Deployment model. Possible values are `OpenAI`, `Cohere`, and `Microsoft`. Changing this forces a new resource to be created.
